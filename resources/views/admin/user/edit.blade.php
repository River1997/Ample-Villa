                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ asset('/admin/user/update') }}/{{ $record->id }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text" class="form-control" @if ($record->role == 'admin') disabled
                                    @endif name="phone" value="{{ $record->client->phone??'' }}" required autocomplete="phone" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="address" class="form-control" @if ($record->role == 'admin') disabled
                                    @endif name="address" value="{{ $record->client->address??'' }}" required autocomplete="address">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="email" type="email" class="form-control "  value="{{ $record->email }}" autocomplete="email" readonly>
